...
torchrun --nproc_per_node=4 --master_port=20119 --master_addr=localhost torchrun_main_muon_test_newest.py \
    ...
    --dtype bfloat16 \
    --eval_every 1000 \
    --wandb_name Mlast_Gv2-130M-lr0.001-lrmuon0.03-WD0.1-step20000-power0.125-repeat1 \
...
torchrun --nproc_per_node=4 --master_port=20119 --master_addr=localhost torchrun_main_muon_test_newest.py \
    ...
    --dtype bfloat16 \
    --eval_every 1000 \
    --wandb_name Mlast_NorGv2-130M-lr0.001-lrmuon0.03-WD0.1-step20000-power0.125-repeat1 \
    --target_eval_tokens 10_000_000 \
    --save_every 10000
...
torchrun --nproc_per_node=4 --master_port=20119 --master_addr=localhost torchrun_main_muon_test_newest.py \
    ...
    --dtype bfloat16 \
    --eval_every 1000 \
    --wandb_name Mlast_Gv2_acc-130M-lr0.001-lrmuon0.03-WD0.1-step20000-power0.125-repeat1 \
    --target_eval_tokens 10_000_000 \
    --save_every 10000
...
torchrun --nproc_per_node=4 --master_port=20119 --master_addr=localhost torchrun_main_muon_test_newest.py \
    ...
    --dtype bfloat16 \
    --eval_every 1000 \
    --wandb_name Mlast_NorGv2_acc-130M-lr0.001-lrmuon0.03-WD0.1-step20000-power0.125-repeat1 \
    --target_eval_tokens 10_000_000 \
    --save_every 10000
...
torchrun --nproc_per_node=2 --master_port=20119 --master_addr=localhost torchrun_main_muon_test_newest.py \
    ...
    --dtype bfloat16 \
    --eval_every 1000 \
    --wandb_name Mlast_Gv2-60M-lr0.001-lrmuon0.03-WD0.1-step10000-power0.125-repeat1 \
    --target_eval_tokens 10_000_000 \
    --save_every 10000
...
torchrun --nproc_per_node=2 --master_port=20119 --master_addr=localhost torchrun_main_muon_test_newest.py \
    ...
    --dtype bfloat16 \
    --eval_every 1000 \
    --wandb_name Mlast_NorGv2-60M-lr0.001-lrmuon0.03-WD0.1-step10000-power0.125-repeat1 \
    --target_eval_tokens 10_000_000 \
    --save_every 10000
...
torchrun --nproc_per_node=2 --master_port=20119 --master_addr=localhost torchrun_main_muon_test_newest.py \
    ...
    --dtype bfloat16 \
    --eval_every 1000 \
    --wandb_name Mlast_Gv2_acc-60M-lr0.001-lrmuon0.03-WD0.1-step10000-power0.125-repeat1 \
    --target_eval_tokens 10_000_000 \
    --save_every 10000
...
torchrun --nproc_per_node=2 --master_port=20119 --master_addr=localhost torchrun_main_muon_test_newest.py \
    ...
    --dtype bfloat16 \
    --eval_every 1000 \
    --wandb_name Mlast_NorGv2_acc-60M-lr0.001-lrmuon0.03-WD0.1-step10000-power0.125-repeat1 \
    --target_eval_tokens 10_000_000 \
    --save_every 10000
